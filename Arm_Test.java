...
public class Arm_Test extends LinearOpMode {
    ...
    double leftFrontPower  = axial + lateral + yaw;
        ...
        while (opModeIsActive()) {
            ...
            Rack_Power = gamepad1.right_trigger - gamepad1.left_trigger;
            if ((Rack_Power >= 0.0) && (Rack_Pos >= Rack_Upper - Rack_Pad)){
                Rack_Power = ((Rack_Upper - Rack_Pos)/Rack_Pad)*Rack_Power;
            }

            if ((Rack_Power <= 0.0) && (Rack_Pos <= Rack_Lower + Rack_Pad)){
                Rack_Power = ((Rack_Pos - Rack_Lower)/Rack_Pad)*Rack_Power;
            }
            ...
            telemetry.addData("Rack_Power", "%4.2f", Rack_Power);
